...
namespace SovokTV.View
{
    ...
    public sealed partial class Login : Page
    {
        ...
        /// <param name="pass">User password data</param>
        /// <param name="code">User secret code for adult channels</param>
